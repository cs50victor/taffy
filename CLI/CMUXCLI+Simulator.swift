...
extension CMUXCLI {
    ...
    func simulatorSubcommandUsage() -> String {
        let usage = String(
            ...
            defaultValue: """
            Usage: taffy simulator <subcommand> [args] [--surface <id|ref|index>]
    ...
    func iosSubcommandUsage() -> String {
        String(
            ...
            defaultValue: """
            Usage: taffy ios <subcommand> [args] [--surface <ref>]

            Every native `taffy simulator` subcommand is accepted unchanged.
            ...
            Examples:
              taffy ios list --json
              taffy ios screenshot --surface surface:2 --out phone.png
              taffy ios screenshot --all --out screenshots/
              taffy ios rotate landscape-left
            """
        )
    }
