...
extension CMUXCLI {
    ...
    func simulatorPermissionsUsageError() -> CLIError {
        CLIError(message: String(
            ...
            defaultValue: """
            Usage:
              taffy simulator permissions list [bundle-id] [--surface <id|ref|index>]
              taffy simulator permissions grant <permission> <bundle-id> [--value <value>] [--surface <id|ref|index>]
              taffy simulator permissions revoke <permission> <bundle-id> [--surface <id|ref|index>]
              taffy simulator permissions reset <permission|all> <bundle-id> [--surface <id|ref|index>]
    ...
    func simulatorInterfaceUsageError() -> CLIError {
        CLIError(message: String(
            ...
            defaultValue: """
            Usage:
              taffy simulator ui [status] [--surface <id|ref|index>]
              taffy simulator ui [get] <option> [--surface <id|ref|index>]
              taffy simulator ui [set] <option> <value> [--surface <id|ref|index>]
