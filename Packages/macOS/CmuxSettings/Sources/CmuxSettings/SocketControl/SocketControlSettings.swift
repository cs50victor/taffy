...
public struct SocketControlSettings {
    ...
    public static let baseDebugBundleIdentifier = "com.cs50victor.taffy.debug"
    private static let stableSocketFileName = "taffy.sock"
    /// Legacy stable socket path used before the Application Support location.
    public static let legacyStableDefaultSocketPath = "/tmp/taffy.sock"
    ...
    public static func initialSocketPathBeforeListenerStart(
        ...
        guard !isDebugBuild,
              normalizedBundleIdentifier(bundleIdentifier) == "com.cs50victor.taffy",
    ...
    private static func shouldReserveStableSocketPath(bundleIdentifier: String?, isDebugBuild: Bool) -> Bool {
        ...
        return normalizedBundleIdentifier(bundleIdentifier) != "com.cs50victor.taffy"
    }
    ...
    public static func userScopedStableSocketPath(currentUserID: uid_t = getuid()) -> String {
        stableSocketDirectoryURL()?
            .appendingPathComponent("taffy-\(currentUserID).sock", isDirectory: false)
            .path ?? "/tmp/taffy-\(currentUserID).sock"
    }
    ...
    public static func isDebugLikeBundleIdentifier(_ bundleIdentifier: String?) -> Bool {
        ...
        return bundleIdentifier == "com.cs50victor.taffy.debug"
            || bundleIdentifier.hasPrefix("com.cs50victor.taffy.debug.")
    }

    /// Whether the bundle identifier is a tagged DEV build (`com.cs50victor.taffy.debug.<tag>`).
    ...
    public static func isStagingBundleIdentifier(_ bundleIdentifier: String?) -> Bool {
        guard let bundleIdentifier else { return false }
        return bundleIdentifier == "com.cs50victor.taffy.staging"
            || bundleIdentifier.hasPrefix("com.cs50victor.taffy.staging.")
    }
