...
public struct CmuxConfigLocation: Sendable, Hashable {
    /// The primary cmux config file: `<home>/.config/taffy/cmux.json`.
    public let userConfigFile: URL

    /// The legacy fallback: `<home>/.config/taffy/settings.json`. The app's
    ...
    public init(home: URL = FileManager.default.homeDirectoryForCurrentUser) {
        ...
        self.userConfigFile = home.appending(path: ".config/taffy/cmux.json")
