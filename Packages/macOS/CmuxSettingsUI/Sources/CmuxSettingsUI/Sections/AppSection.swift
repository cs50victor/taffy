...
public struct AppSection: View {
    ...
    private var globalFontMagnificationSubtitle: String {
        ...
        return String(
            ...
            defaultValue: "Scale every font in Taffy by the same percentage. 100% = design size."
        )
    }
    ...
    private var mainCard: some View {
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                subtitle: languageOverrideTouched || (languageAtAppear != nil && language.current != languageAtAppear) ? String(localized: "settings.app.language.restartSubtitle", defaultValue: "Restart Taffy to apply") : nil,
            ...
            SettingsCardRow(
                ...
                subtitle: firstClick.current
                    ? String(localized: "settings.app.paneFirstClickFocus.subtitleOn", defaultValue: "When Taffy is inactive, clicking a pane activates the window and focuses that pane in one click.")
                    : String(localized: "settings.app.paneFirstClickFocus.subtitleOff", defaultValue: "When Taffy is inactive, the first click only activates the window. Click again to focus the pane.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.configWindow.subtitle", defaultValue: "Open the Taffy terminal config and generated preview in one utility window."),
                controlWidth: Self.columnWidth
            ) {
            ...
            SettingsCardRow(
                ...
                String(localized: "settings.app.openMarkdownInCmuxViewer", defaultValue: "Open Markdown in Taffy Viewer"),
                subtitle: String(localized: "settings.app.openMarkdownInCmuxViewer.subtitle", defaultValue: "When supported file routing is on, Cmd-clicking Markdown files opens the rendered Taffy markdown viewer instead of the generic file preview.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.showInMenuBar.subtitle", defaultValue: "Keep Taffy in the menu bar for unread notifications and quick actions.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.notifications.paneFlash.subtitle", defaultValue: "Briefly flash an outline when Taffy highlights a pane.")
            ) {
