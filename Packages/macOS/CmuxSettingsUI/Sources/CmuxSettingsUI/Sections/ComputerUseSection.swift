...
public struct ComputerUseSection: View {
    ...
    private var accessibilityRow: some View {
        SettingsCardRow(
            ...
            subtitle: String(localized: "settings.computerUse.permission.accessibility.subtitle", defaultValue: "Lets Taffy Computer Use inspect and control app interfaces.")
        ) {
            permissionControls(
    ...
    private var screenRecordingRow: some View {
        SettingsCardRow(
            ...
            subtitle: String(localized: "settings.computerUse.permission.screenRecording.subtitle", defaultValue: "Lets Taffy Computer Use see app windows and screen content.")
        ) {
            permissionControls(
