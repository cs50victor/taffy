...
public struct SidebarSection: View {
    ...
    private var mainCard: some View {
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in Taffy Browser"),
            ...
            SettingsCardRow(
                ...
                String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in Taffy Browser"),
                subtitle: portLinks.current
                    ? String(localized: "settings.app.openSidebarPortLinks.subtitleOn", defaultValue: "Port clicks open inside taffy browser.")
    ...
    private func prLinksSubtitle(prVisible: Bool, prClickable: Bool, openInCmux: Bool) -> String {
        ...
        return openInCmux
            ? String(localized: "settings.app.openSidebarPRLinks.subtitleOn", defaultValue: "Clicks open inside taffy browser.")
