...
enum CLIForwardingLaunchRouter {
    ...
    private static func localizedMissingBundledCLIError() -> String {
        String(
            ...
            defaultValue: "Taffy could not run this command from the app bundle. Reinstall Taffy or run the command from a standard Taffy CLI installation."
        )
    }
    ...
    private static func localizedArgumentAllocationError() -> String {
        String(
            ...
            defaultValue: "Taffy could not start this command. Try again, or reinstall Taffy if the problem continues."
        )
    }
    ...
    private static func localizedExecFailureError() -> String {
        String(
            ...
            defaultValue: "Taffy could not start the command-line tool from the app bundle. Reinstall Taffy or run the command from a standard Taffy CLI installation."
        )
    }
