...
struct AccountSignInView: View {
    ...
    var idleTitle = String(localized: "account.signIn.heading", defaultValue: "Sign in to Taffy")
    /// Idle-state supporting line under ``idleTitle``.
    var idleSubtitle = String(
        localized: "account.signIn.prompt",
        defaultValue: "Continue with your Taffy account."
    )
    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            Text(String(
                ...
                defaultValue: "Your Taffy account is connected."
            ))
            .font(.caption)
            .foregroundStyle(.secondary)
        }
    ...
    var instructions: String {
        ...
        case .openingBrowser:
            return String(
                ...
                defaultValue: "Taffy is preparing a secure sign-in window."
            )
        case .waiting:
            return String(
        ...
        case .finishing:
            return String(
                ...
                defaultValue: "Taffy is verifying your account. Keep this pane open."
            )
        }
    }
...
private extension AccountSignInModel.Failure {
    var title: String {
        ...
        case .network:
            return String(localized: "account.signIn.error.network.title", defaultValue: "Couldn’t reach Taffy")
        case .timedOut:
            return String(localized: "account.signIn.error.timedOut.title", defaultValue: "Sign-in timed out")
        case .server:
            return String(localized: "account.signIn.error.server.title", defaultValue: "Taffy sign-in is temporarily unavailable")
        case .invalidLink:
        ...
        case .unauthorized:
            return String(localized: "account.signIn.error.unauthorized.title", defaultValue: "Taffy couldn’t authorize this sign-in")
        case .rejected:
            return String(localized: "account.signIn.error.rejected.title", defaultValue: "Taffy couldn’t complete the sign-in")
        case .unknown:
    ...
    var recovery: String {
        ...
        case .server:
            return String(
                ...
                defaultValue: "Try again in a moment. Your account and existing taffy workspaces are unchanged."
            )
        case .invalidLink:
            return String(
        ...
        case .unauthorized:
            return String(
                ...
                defaultValue: "Confirm you’re using the intended Taffy account, then try again."
            )
        case .rejected:
            return String(
