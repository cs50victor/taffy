    ...
    final class Coordinator: NSObject, NSOutlineViewDataSource, NSOutlineViewDelegate {
        ...
        private func resourceMenuItems(
            ...
            if resource.id.isForwardedPort, !isLocal {
                ...
                items.append(item(String(localized: "machines.menu.setupVPN", defaultValue: "Set Up Taffy VPN…")) { [machineActions, window = outlineView?.window] in machineActions.setupVPN(window) })
            } else if let portURL {
