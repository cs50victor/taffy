    ...
    static func commandPaletteProCommandContributions() -> [CommandPaletteCommandContribution] {
        ...
        return [
            CommandPaletteCommandContribution(
                ...
                title: constant(String(localized: "command.pro.welcomeChecklist.title", defaultValue: "Welcome to Taffy Pro")),
            ...
            CommandPaletteCommandContribution(
                ...
                title: constant(String(localized: "command.pro.upgrade.title", defaultValue: "Upgrade to Taffy Pro")),
                subtitle: constant(String(localized: "command.auth.subtitle", defaultValue: "Account")),
